...
public class BlogPostControllerTests {
  ...
  public void postCreatesNewBlogEntry_Test(@Autowired MockMvc mockMvc)
    ...
    MvcResult result = mockMvc.perform(post(RESOURCE_URI).with(jwt())
      ...
      .andExpect(
        jsonPath("$.content").value(savedPosting.getContent()))
      .andExpect(
        jsonPath("$.author.id").value(savedPosting.getAuthor().getId()))
      .andReturn();
  ...
  public void sTest02(@Autowired MockMvc mockMvc) throws Exception {
    ...
    savedPosting.setDatePosted(null);
